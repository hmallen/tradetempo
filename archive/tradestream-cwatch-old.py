...
from archive.tickertape import TickerTape
...
class CryptowatchStream:
    def __init__(self, top_markets):
        ...
        cw.stream.on_orderbook_delta_update = (
            CryptowatchStream.handle_orderbook_delta_updates
        )
        cw.stream.on_orderbook_spread_update = (
            CryptowatchStream.handle_orderbook_spread_updates
        )
        cw.stream.on_orderbook_snapshot_update = (
            CryptowatchStream.handle_orderbook_snapshot_updates
        )
